...
if REFERENCE_TEXT:
    st.success("📚 Loaded reference architecture docs from ./reference_docs ✅")
else:
    st.info("📚 You can add .txt/.md files under ./reference_docs to use as reference architecture notes.")
...
st.markdown(
    ...
    <div class="feature-card">
        ...
        🛠️ <b>ETL Job Design</b> for Talend, Informatica, Ab Initio<br>
...
etl_tool_option = st.selectbox(
    ...
    ["None", "Talend", "Informatica", "Ab Initio"],
    index=0,
)
...
def generate_etl_design(out_state: Dict[str, Any], etl_tool: str) -> str:
    ...
    system_prompt = (
        ...
        "Generate an ETL pipeline design for this tool (Talend / Informatica / Ab Initio).\n\n"
        "FORMAT:\n"
    ...
    user_prompt = "ETL Tool: " + etl_tool + "\nPipeline Context:\n" + context
    return call_claude(system_prompt, user_prompt, max_tokens=1800)
